...
public class adminGUI extends JFrame {
	...
	public void initComponent() {
		...
		panel.setBounds(0, 139, 277, 428);
		contentPane.add(panel);
		panel.setLayout(null);
		
		JButton btnUser = new JButton("Quản lí người dùng");
		...
		btnUser.setBounds(0, 240, 277, 64);
		panel.add(btnUser);
...
//				u.f.setVisible(true);
		...
		JButton btnEmployee = new JButton("Quản lí nhân viên");
		btnEmployee.setIcon(new ImageIcon("Image\\worker-3-32.png"));
		...
		btnEmployee.setBounds(0, 360, 277, 68);
