...
public class employeeInterfaceGUI extends JFrame {
	...
	public employeeInterfaceGUI(String code) {
		employeeCode = accBLL.getCode("employee", "EMPLOYEE_CODE", code, "ACCOUNT_ID");
		initComponent();
	}
	/**
	 * Create the frame.
	...
	public void initComponent() {
		...
		panel.setBounds(0, 139, 277, 248);
		contentPane.add(panel);
		panel.setLayout(null);
		
		JButton btnUser = new JButton("Danh sách người dùng");
		...
		btnUser.setBounds(0, 124, 277, 64);
		panel.add(btnUser);
		...
		btnProduct.setBounds(0, 60, 277, 64);
		...
		btnAccount.setBounds(0, 184, 277, 64);
