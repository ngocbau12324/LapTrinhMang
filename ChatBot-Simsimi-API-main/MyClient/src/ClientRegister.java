    ...
    private void btnConnectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConnectActionPerformed
        // TODO add your handling code here:        
                try {
                    ...
                    AES.createKeyAES();
                        try {
                                //send key AES được mã hóa bằng RSA to server
                                RSA.KeyPublicRSAServer=in.readLine();
                                //System.out.println("Nhận Key RSA public :"+ RSA.KeyPublicRSAServer);
                                String keyAES=RSA.MaHoaDuLieu(AES.GetKeyAES());
                                //System.out.println("AES key: "+AES.GetKeyAES());
                                //System.out.println("Gửi AES key đã được mã bằng RSA:"+keyAES);
                                
                                System.out.println("Client tạo Secret Key: "+ AES.GetKeyAES());
                                System.out.println("Client lấy Public Key của server: " + RSA.KeyPublicRSAServer);
                                System.out.println("Client dùng Publickey mã hóa SecretKey gửi cho Server: "+ keyAES);
