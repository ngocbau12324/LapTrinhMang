...
public class ChiTietHoaDonFRM extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ChiTietHoaDonNhapFRM
     */
    public ChiTietHoaDonFRM() {
        ...
        setTitle("Quản lý chi tiết hóa đơn xuất");
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Thông tin chi tiết hóa đơn"));
        ...
        cbMakm.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                cbMakmKeyTyped(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(cbMahd, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jt.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã hóa đơn", "Mã sản phẩm", "Đơn giá", "Số lượng", "Mã khuyến mãi", "Thành tiền"
            }
        ) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            if(i >= 0){
                ChiTietHoaDonDTO hd = getFromTextField();
    ...
    private void cbMaspActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbMaspActionPerformed
        ...
        ChiTietHoaDonBUS bus = new ChiTietHoaDonBUS();
        try{
            String dongia = bus.getDonGia("sanpham",cbMasp.getSelectedItem()+"");
    ...
    private void cbMakmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbMakmActionPerformed
        ChiTietHoaDonBUS ct = new ChiTietHoaDonBUS();
        String a="0";
        try {
            a=ct.getgiamgia("thongtinkhuyenmai", cbMasp.getSelectedItem()+"", cbMakm.getSelectedItem()+"");
                        System.out.print(a);
            if(a.equals("no")) a="0";
// TODO add your handling code here:
        } catch (Exception ex) {
            Logger.getLogger(ChiTietHoaDonFRM.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        try{
             int re = (int) ((100-Integer.parseInt(a))/100.0*Integer.parseInt(txtSoluong.getText())*Integer.parseInt(txtDongia.getText()));
             txtThanhtien.setText(String.valueOf(re));
         }catch(Exception e){} 
    }//GEN-LAST:event_cbMakmActionPerformed

    private void cbMakmKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cbMakmKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_cbMakmKeyTyped
    ...
    public void setModelValue(ChiTietHoaDonDTO hd,int i){
    ...
    public ChiTietHoaDonDTO getFromTextField(){
        ...
        hd.setMaKhuyenmai(cbMakm.getSelectedItem()+"");
        hd.setThanhtien(Integer.parseInt(txtThanhtien.getText()));
        return hd;
    }
    public Vector setVector(ChiTietHoaDonDTO hd){
        Vector vt = new Vector();
        vt.add(hd.getMahd());
        vt.add(hd.getMasp());
        vt.add(hd.getDongia());
        vt.add(hd.getSoluong());
        vt.add(hd.getMaKhuyenmai());
        vt.add(hd.getThanhtien());
        return vt;
    }
    public void showOnTable(ArrayList<ChiTietHoaDonDTO> ds){
        model=(DefaultTableModel)jt.getModel();
        model.setRowCount(0);
        for(ChiTietHoaDonDTO hd:ds){
    ...
    public void loadCacClassKhac(){
        ChiTietHoaDonBUS bus = new ChiTietHoaDonBUS();
        Vector mahd = bus.load("hoadon");
        Vector masp = bus.load("sanpham");
        Vector loc = bus.load("hoadon");
        Vector makm = bus.load("khuyenmai");
        loc.add("Tất cả");
